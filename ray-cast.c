...
int main(int argc, char** argv)
{
	...
	mySphere[0] = newSphere( 3, 3, 3, 0.8,0.9, 0.2,100,0.5,0.3, 1,0,0, 1);
	mySphere[1] = newSphere( 3, 3,-3, 0.8,0.9, 0.2,100,0.5,0.3, 1,1,0, 1);
	mySphere[2] = newSphere( 3,-3, 3, 0.8,0.9, 0.2,100,0.5,0.3, 1,0,1, 1);
	mySphere[3] = newSphere( 3,-3,-3, 0.8,0.9, 0.2,100,0.5,0.3, 0,1,1, 1);
	mySphere[4] = newSphere(-3, 3, 3, 0.8,0.9, 0.2,100,0.5,0.3, 0,1,0, 1);
	mySphere[5] = newSphere(-3, 3,-3, 0.8,0.9, 0.2,100,0.5,0.3, 1,1,0, 1);
	mySphere[6] = newSphere(-3,-3, 3, 0.8,0.9, 0.2,100,0.5,0.3, 1,0,1, 1);
	mySphere[7] = newSphere(-3,-3,-3, 0.8,0.9, 0.2,100,0.5,0.3, 0,1,1, 1);

	myCube[0] = newCube(0,0,0, 0,1.6, 0.2,100,0.5,0.5, 0,0,1, 6);

	myLights[0] = newLight(5,5,10, 1,1,1, 250);
