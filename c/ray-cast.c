...
void rayCast () {
	...
	if (changed) {
		...
		if (changed > 1)
			rayzor = newRayCaster(myCamera,5);
...
int main(int argc, char** argv)
{
	...
	mySphere[0] = newSphere( 3, 3, 3, 0.7, 0.5,50,0.5,0.1, 1,0,0, 2);
	mySphere[1] = newSphere( 3, 3,-3, 0.7, 0.5,50,0.5,0.1, 1,1,0, 2);
	mySphere[2] = newSphere( 3,-3, 3, 0.7, 0.5,50,0.5,0.1, 1,0,1, 2);
	mySphere[3] = newSphere( 3,-3,-3, 0.7, 0.5,50,0.5,0.1, 0,1,1, 2);
	mySphere[4] = newSphere(-3, 3, 3, 0.7, 0.5,50,0.5,0.1, 0,1,0, 2);
	mySphere[5] = newSphere(-3, 3,-3, 0.7, 0.5,50,0.5,0.1, 1,1,0, 2);
	mySphere[6] = newSphere(-3,-3, 3, 0.7, 0.5,50,0.5,0.1, 1,0,1, 2);
	mySphere[7] = newSphere(-3,-3,-3, 0.9, 0.5,50,0.5,0.1, 0,1,1, 2);

	myCube[0] = newCube(0,0,0, 0, 0.2,100,0.5,0.5, 0,0,1, 6);
